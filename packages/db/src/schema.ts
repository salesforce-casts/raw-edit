...
export const userProfiles = pgTable("user_profiles", {
  ...
  pacingPreset: text("pacing_preset").notNull().default("natural"),
...
export const videos = pgTable(
  "videos",
  {
    ...
    removeFillers: boolean("remove_fillers").notNull().default(false),
    pacingPreset: text("pacing_preset").notNull().default("natural"),
    keyframeMs: jsonb("keyframe_ms").$type<number[]>().notNull().default([]),
    filmstripStorageKey: text("filmstrip_storage_key"),
    scriptPassWarning: text("script_pass_warning"),
...
export const editVersions = pgTable(
  "edit_versions",
  {
    ...
    scriptPassModel: text("script_pass_model"),
    scriptPassCacheKey: text("script_pass_cache_key"),
    scriptPassDecisions: jsonb("script_pass_decisions").$type<unknown>(),
    createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
  },
